...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button class="sponsor" onclick="globalThis.open('https://www.qinglin.co')" style="background: linear-gradient(90deg,#946ce6,#7e5fd9); left:auto; right:50%; transform: translate(-2rem,-50%);">打赏策划</button>
            <button class="sponsor" onclick="globalThis.open('https://www.qinglin.co')" style="background-color:#c69; left:50%; right:auto; transform: translate(2rem,-50%);">打赏程序(顿顿饭)</button>
